...
function _shouldScheduleTimer(timeout) {
	return !require_environmentManager.environmentManager.isServer() && require_utils.resolveQueryBoolean(this.options.enabled, require_classPrivateFieldSet2._classPrivateFieldGet2(_currentQuery, this)) !== false && require_utils.isValidTimeout(timeout);
}
